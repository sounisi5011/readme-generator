...
/**
 * {@link https://github.com/mozilla/nunjucks/blob/v3.2.1/nunjucks/src/lib.js#L47-L136 Source}
 */
...
> extends Error {
     ...
     */
    readonly name: 'Template render error';

    /**
     * {@link https://github.com/mozilla/nunjucks/blob/v3.2.1/nunjucks/src/lib.js#L93-L95 Source}
     */
    readonly cause: TMessage extends Error ? TMessage : undefined;
